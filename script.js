...
let upgradeData = [
  ...
  { name: "Jade Cursor", displayCost: "150T", cost: 150_000_000_000_000, cat: 1, displayPower: "2T", power: 2_000_000_000_000, imgName: "Bronze Cursor.png" },
  { name: "Candy Planet", displayCost: "10Q", cost: 10_000_000_000_000_000n, cat: 2, displayPower: "100T", power: 100_000_000_000_000, imgName: "Candy Mine.png" },
  { name: "Candy Star", displayCost: "75Q", cost: 75_000_000_000_000_000n, cat: 2, displayPower: "1Q", power: 1_000_000_000_000_000, imgName: "Candy Farm.png" },
  { name: "Candy System", displayCost: "250Q", cost: 250_000_000_000_000_000n, cat: 2, displayPower: "10Q", power: 10_000_000_000_000_000n, imgName: "Candy Temple.png" }
];

function loadUpgrades() {
    const upgradeBoxes = document.querySelectorAll('.upgrade');

    upgradeBoxes.forEach((box, index) => {
    ...
    if (data.cat === 1) {
        box.addEventListener("click", () => {addClickPower(index)});
    } else {
        box.addEventListener("click", () => {addCPS(index)});
    }
    });
}
